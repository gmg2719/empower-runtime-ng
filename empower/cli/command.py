...
from empower.cli.applications import pa_list_apps, do_list_apps, \
    pa_list_apps_catalog, do_list_apps_catalog, \
    pa_load_app, do_load_app, pa_unload_app, do_unload_app, \
    pa_unload_all_apps, do_unload_all_apps, pa_set_app_params, \
    do_set_app_params
...
CMDS = {
    ...
    'list-apps-catalog': (pa_list_apps_catalog, do_list_apps_catalog),
