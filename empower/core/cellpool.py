...
class Cell:
    ...
    def to_dict(self):
        ...
        ues = {str(k): v for k, v in self.ue_measurements.items()}
        cells = {str(k): v for k, v in self.cell_measurements.items()}
        ...
        out['cell_measurements'] = cells
        out['ue_measurements'] = ues
