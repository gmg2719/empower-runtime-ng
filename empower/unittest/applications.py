...
class TestApplications(BaseTest):
    ...
    def test_modify_app_attribute(self):
        """test_modify_app_attribute."""
        ...
        req = requests.get(url=URL % ("root", "root", loc + "/stats"))
        text = json.loads(req.text)
        self.assertEqual(text, "null value")
    ...
    def test_modify_invalid_app_attribute(self):
        """test_modify_invalid_app_attribute."""
